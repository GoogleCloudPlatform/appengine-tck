...
ARTIFACT_IDS=(appengine-api-1.0-sdk appengine-jsr107cache appengine-tools-sdk)
JAR_PATTERN=(appengine-api-1.0-sdk-*.jar appengine-jsr107cache-*.jar appengine-tools-api*.jar)
