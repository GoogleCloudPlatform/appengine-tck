...
public class LogLevelFineTest extends LoggingConfigurationTestBase {

    @Deployment
    public static Archive getDeployment() {
        return getDeploymentWithLoggingLevelSetTo(Level.FINE);
    }

    @Test
    public void testLogLevelFine() {
        assertLogOnlyLogsMessagesAboveOrAtLevel(Level.FINE);
    }
}
