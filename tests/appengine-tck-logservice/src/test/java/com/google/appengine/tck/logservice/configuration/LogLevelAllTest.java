...
public class LogLevelAllTest extends LoggingConfigurationTestBase {

    @Deployment
    public static Archive getDeploymentLogLevelAll() {
        return getDeploymentWithLoggingLevelSetTo(Level.ALL);
    }
