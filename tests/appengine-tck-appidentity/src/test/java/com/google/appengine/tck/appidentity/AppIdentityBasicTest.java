...
public class AppIdentityBasicTest extends AppIdentityTestBase {
    ...
    public void testGetAppId() {
        ...
        String errMsg = "The appId should end with " + appIdproperty + ", but was " + appId;
        Assert.assertTrue(errMsg, appId.endsWith(appIdproperty));
    }
    ...
    public void testGetVersionedHostname() {
        ...
        Assert.assertTrue(hostname, hostname.endsWith(appEngineServer));
    }
}
