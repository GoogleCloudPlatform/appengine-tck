...
public class SchemaTest extends DatastoreTestBase {
  ...
  public void testNamespaceMetadata() {
    ...
    q.setFilter(new FilterPredicate(Entity.KEY_RESERVED_PROPERTY, FilterOperator.IN, 
  ...
  public void testPropertyMetadata() {
    ...
    q.setFilter(CompositeFilterOperator.and(
        ...
        new FilterPredicate(Entity.KEY_RESERVED_PROPERTY, FilterOperator.LESS_THAN_OR_EQUAL, 
                            key2)));
  ...
  public void testEntityGroupMetadata() throws EntityNotFoundException {
    if (datastoreService.getDatastoreAttributes().getDatastoreType() == 
