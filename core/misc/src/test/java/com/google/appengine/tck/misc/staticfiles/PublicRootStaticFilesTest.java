...
public class PublicRootStaticFilesTest extends StaticFilesTestBase {
    ...
    @Test
    @RunAsClient
    public void testPublicRoot(@ArquillianResource URL url) throws Exception {
        assertResponseEquals("This is /static/foo.txt", url, "foo.txt");
        assertResponseEquals("This is /static/subdir/foo.txt", url, "subdir/foo.txt");
        assertPageNotFound(url, "bar.txt");
    }
}
