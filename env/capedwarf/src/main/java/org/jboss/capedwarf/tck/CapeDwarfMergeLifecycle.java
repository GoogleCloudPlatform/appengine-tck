...
import com.google.appengine.tck.event.AbstractMergeLifecycle;
...
public class CapeDwarfMergeLifecycle extends AbstractMergeLifecycle {
    ...
    protected void doAfter(MergeLifecycleEvent event) {
    }
}
